...
## 品牌共性
- 风格：标准。清楚、可信、熟悉的产品界面
- 表面语言：平静表面、适中圆角；层次只在需要区分内容时出现
- 形状：8px / 12px / 12px；同类组件全站一致。
...
- 当前风格字形：中性无衬线、字面标准、笔画均匀；依靠字号与字重建立层级
- 展示字体：`-apple-system, "Segoe UI", "Inter", "PingFang SC", "Hiragino Sans GB", "Noto Sans SC", "Microsoft YaHei", sans-serif`
...
## 设计变量
### 强调色
- `--color-accent-base`: #f9a217（亮） / #c07f24（暗） — 主强调色（主按钮、激活链接）
- `--color-accent-hover`: #c67900（亮） / #d6a35a（暗） — 强调色悬停态
- `--color-accent-active`: #734400（亮） / #efd3a8（暗） — 强调色按压态
- `--color-accent-subtle`: #fce8d2（亮） / #2b1700（暗） — 浅色强调背景（标签底色）
- `--color-accent-on-accent`: #0F172A（亮） / #FFFFFF（暗） — 主按钮上的对比前景文字（自适应 APCA）
- `--color-focus-ring`: #eaba83（亮） / #603800（暗） — 输入框/按钮聚焦环
- `--color-accent-2`: #ff8a76（亮） / #d26e5f（暗） — 渐变搭档色（主色 ±40° 色相，与主色同明度色度）
- `--gradient-brand`: linear-gradient(135deg, var(--color-accent-base), var(--color-accent-2)) — 品牌主渐变（Hero / 主 CTA 背景）
### 中性色
- `--color-bg-primary`: #fff9f3（亮） / #070200（暗） — 页面背景基底
- `--color-bg-secondary`: #fffffd（亮） / #0d0804（暗） — 卡片 / 容器表面层
- `--color-bg-tertiary`: #fef5ec（亮） / #191511（暗） — 悬停态背景
- `--color-border`: #e4d5c4（亮） / #2a2826（暗） — 边框与分割线
- `--color-text-primary`: #272320（亮） / #d4d0cb（暗） — 正文主要文字
- `--color-text-secondary`: #6c6864（亮） / #aeaaa5（暗） — 次要描述文字与小图标
- `--color-text-muted`: #938e89（亮） / #75716b（暗） — 输入框占位字与禁用态文字
- `--color-text-emphasis`: #090705（亮） / #f2eee9（暗） — 标题与高强调文字
- `--color-surface-raised`: #fffffd（亮） / #130f0a（暗） — 浮层表面（弹窗 / Popover / 下拉）
### 交互态
- `--color-disabled-bg`: #fff9f3（亮） / #070200（暗） — 禁用态背景色
- `--color-disabled-text`: #938e89（亮） / #75716b（暗） — 禁用态文字颜色（neutral-300 占位级，可辨识）
- `--color-disabled-border`: #e4d5c4（亮） / #2a2826（暗） — 禁用态边框颜色
- `--focus-ring-shadow`: 0 0 0 3px color-mix(in srgb, var(--color-focus-ring) 45%, transparent) — 聚焦环（颜色 + 宽度 + 偏移三件套）
### 辅助色
- `--color-surface-secondary`: #ffdfba（亮） / #200c00（暗） — 同源大面积辅助背景色
- `--color-surface-secondary-hover`: #efb878（亮） / #371900（暗） — 同源辅助卡片/悬停层
- `--color-surface-secondary-active`: #d88b10（亮） / #582b00（暗） — 同源辅助选中/高亮态
### 功能色
- `--color-success`: #297d0f（亮） / #559247（暗） — 确认与成功反馈状态色
- `--color-success-subtle`: #ddf8d7（亮） / #061603（暗） — 成功反馈淡底背景
- `--color-warning`: #f16935（亮） / #d56e48（暗） — 警告与提醒状态色
- `--color-warning-subtle`: #ffe2d2（亮） / #230801（暗） — 警告提醒淡底背景
...
- `--radius-sm`: 8px — 标准品牌形状
- `--radius-md`: 12px — 标准品牌形状
- `--radius-lg`: 12px — 标准品牌形状
### 排版
...
### 区域配色
- `--region-canvas-bg`: #f3d8bb（亮） / #211101（暗） — 区域背景
- `--region-canvas-text`: #0d0a07（亮） / #fdf9f5（暗） — 区域正文
- `--region-canvas-text-secondary`: #372d22（亮） / #cec4b8（暗） — 区域次要文字
- `--region-canvas-border`: #b9aa99（亮） / #42382c（暗） — 区域边框
- `--region-canvas-surface`: #fde4c9（亮） / #281a08（暗） — 区域内层表面
- `--region-canvas-action`: #0d0b08（亮） / #fdf9f6（暗） — 区域内深色表面
- `--region-canvas-action-text`: #fcfaf8（亮） / #0b0a09（暗） — 区域内行动文字
- `--region-canvas-focus`: #0d0b08（亮） / #fdf9f6（暗） — 区域内焦点环
- `--region-canvas-success`: #297d0f（亮） / #559247（暗） — 区域内成功状态色
- `--region-canvas-warning`: #ce5321（亮） / #d56e48（暗） — 区域内警告状态色
- `--region-canvas-error`: #bb061e（亮） / #c64d49（暗） — 区域内错误状态色
- `--region-canvas-info`: #0070cb（亮） / #2389d1（暗） — 区域内信息状态色
- `--region-brand-bg`: #7e3c00（亮） / #4a1700（暗） — 区域背景
- `--region-brand-text`: #fff8eb（亮） / #fff8ec（暗） — 区域正文
- `--region-brand-text-secondary`: #d3c3b1 — 区域次要文字
- `--region-brand-border`: #87745e（亮） / #5b4935（暗） — 区域边框
- `--region-brand-surface`: #8d5000（亮） / #592a00（暗） — 区域内层表面
- `--region-brand-action`: #fff8ec（亮） / #fff8ee（暗） — 区域内浅色表面
- `--region-brand-action-text`: #0c0a08 — 区域内行动文字
- `--region-brand-focus`: #fff8ec（亮） / #fff8ee（暗） — 区域内焦点环
- `--region-brand-success`: #69af59（亮） / #559247（暗） — 区域内成功状态色
- `--region-brand-warning`: #fb7645（亮） / #d56e48（暗） — 区域内警告状态色
- `--region-brand-error`: #fa736d（亮） / #c64d49（暗） — 区域内错误状态色
- `--region-brand-info`: #32a5f7（亮） / #2389d1（暗） — 区域内信息状态色
### 字体
- `--font-display`: -apple-system, "Segoe UI", "Inter", "PingFang SC", "Hiragino Sans GB", "Noto Sans SC", "Microsoft YaHei", sans-serif — 标准展示字体。中性无衬线、字面标准、笔画均匀；依靠字号与字重建立层级
...
- `--font-latin-display`: -apple-system, "Segoe UI", "Inter", sans-serif — 拉丁展示字体
### 间距阶梯
...
:root {
  /* 强调色 */
  --color-accent-base: #f9a217; /* 主强调色（主按钮、激活链接） */
  --color-accent-hover: #c67900; /* 强调色悬停态 */
  --color-accent-active: #734400; /* 强调色按压态 */
  --color-accent-subtle: #fce8d2; /* 浅色强调背景（标签底色） */
  --color-accent-on-accent: #0F172A; /* 主按钮上的对比前景文字（自适应 APCA） */
  --color-focus-ring: #eaba83; /* 输入框/按钮聚焦环 */
  --color-accent-2: #ff8a76; /* 渐变搭档色（主色 ±40° 色相，与主色同明度色度） */
  --gradient-brand: linear-gradient(135deg, var(--color-accent-base), var(--color-accent-2)); /* 品牌主渐变（Hero / 主 CTA 背景） */
  /* 中性色 */
  --color-bg-primary: #fff9f3; /* 页面背景基底 */
  --color-bg-secondary: #fffffd; /* 卡片 / 容器表面层 */
  --color-bg-tertiary: #fef5ec; /* 悬停态背景 */
  --color-border: #e4d5c4; /* 边框与分割线 */
  --color-text-primary: #272320; /* 正文主要文字 */
  --color-text-secondary: #6c6864; /* 次要描述文字与小图标 */
  --color-text-muted: #938e89; /* 输入框占位字与禁用态文字 */
  --color-text-emphasis: #090705; /* 标题与高强调文字 */
  --color-surface-raised: #fffffd; /* 浮层表面（弹窗 / Popover / 下拉） */
  /* 交互态 */
  --color-disabled-bg: #fff9f3; /* 禁用态背景色 */
  --color-disabled-text: #938e89; /* 禁用态文字颜色（neutral-300 占位级，可辨识） */
  --color-disabled-border: #e4d5c4; /* 禁用态边框颜色 */
  --focus-ring-shadow: 0 0 0 3px color-mix(in srgb, var(--color-focus-ring) 45%, transparent); /* 聚焦环（颜色 + 宽度 + 偏移三件套） */
  /* 辅助色 */
  --color-surface-secondary: #ffdfba; /* 同源大面积辅助背景色 */
  --color-surface-secondary-hover: #efb878; /* 同源辅助卡片/悬停层 */
  --color-surface-secondary-active: #d88b10; /* 同源辅助选中/高亮态 */
  /* 功能色 */
  --color-success: #297d0f; /* 确认与成功反馈状态色 */
  --color-success-subtle: #ddf8d7; /* 成功反馈淡底背景 */
  --color-warning: #f16935; /* 警告与提醒状态色 */
  --color-warning-subtle: #ffe2d2; /* 警告提醒淡底背景 */
  ...
  --motion-feedback-duration: 220ms; /* 营销说服用途角色 */
  /* 区域配色 */
  --region-canvas-bg: #f3d8bb; /* 区域背景 */
  --region-canvas-text: #0d0a07; /* 区域正文 */
  --region-canvas-text-secondary: #372d22; /* 区域次要文字 */
  --region-canvas-border: #b9aa99; /* 区域边框 */
  --region-canvas-surface: #fde4c9; /* 区域内层表面 */
  --region-canvas-action: #0d0b08; /* 区域内深色表面 */
  --region-canvas-action-text: #fcfaf8; /* 区域内行动文字 */
  --region-canvas-focus: #0d0b08; /* 区域内焦点环 */
  --region-canvas-success: #297d0f; /* 区域内成功状态色 */
  --region-canvas-warning: #ce5321; /* 区域内警告状态色 */
  --region-canvas-error: #bb061e; /* 区域内错误状态色 */
  --region-canvas-info: #0070cb; /* 区域内信息状态色 */
  --region-brand-bg: #7e3c00; /* 区域背景 */
  --region-brand-text: #fff8eb; /* 区域正文 */
  --region-brand-text-secondary: #d3c3b1; /* 区域次要文字 */
  --region-brand-border: #87745e; /* 区域边框 */
  --region-brand-surface: #8d5000; /* 区域内层表面 */
  --region-brand-action: #fff8ec; /* 区域内浅色表面 */
  --region-brand-action-text: #0c0a08; /* 区域内行动文字 */
  --region-brand-focus: #fff8ec; /* 区域内焦点环 */
  --region-brand-success: #69af59; /* 区域内成功状态色 */
  --region-brand-warning: #fb7645; /* 区域内警告状态色 */
  --region-brand-error: #fa736d; /* 区域内错误状态色 */
  --region-brand-info: #32a5f7; /* 区域内信息状态色 */
  /* 字体 */
  --font-display: -apple-system, "Segoe UI", "Inter", "PingFang SC", "Hiragino Sans GB", "Noto Sans SC", "Microsoft YaHei", sans-serif; /* 标准展示字体。中性无衬线、字面标准、笔画均匀；依靠字号与字重建立层级 */
  --font-body: "PingFang SC", "Hiragino Sans GB", "Noto Sans SC", "Microsoft YaHei", sans-serif; /* 中文正文字体 */
  --font-data: "SF Mono", Menlo, "Cascadia Code", Consolas, ui-monospace, monospace; /* 数据与代码字体，配合 tabular-nums */
...
[data-theme="dark"] {
  --color-accent-base: #c07f24;
  --color-accent-hover: #d6a35a;
  --color-accent-active: #efd3a8;
  --color-accent-subtle: #2b1700;
  --color-accent-on-accent: #FFFFFF;
  --color-focus-ring: #603800;
  --color-bg-primary: #070200;
  --color-bg-secondary: #0d0804;
  --color-bg-tertiary: #191511;
  --color-border: #2a2826;
  --color-text-primary: #d4d0cb;
  --color-text-secondary: #aeaaa5;
  --color-text-muted: #75716b;
  --color-text-emphasis: #f2eee9;
  --color-disabled-bg: #070200;
  --color-disabled-text: #75716b;
  --color-disabled-border: #2a2826;
  --color-surface-secondary: #200c00;
  --color-surface-secondary-hover: #371900;
  --color-surface-secondary-active: #582b00;
  --color-success: #559247;
  --color-success-subtle: #061603;
  --color-warning: #d56e48;
  --color-warning-subtle: #230801;
  --color-error: #c64d49;
  --color-error-subtle: #250505;
  --color-info: #2389d1;
  --color-info-subtle: #001326;
  --color-accent-2: #d26e5f;
  --gradient-brand: linear-gradient(135deg, var(--color-accent-base), var(--color-accent-2));
  --color-surface-raised: #130f0a;
  ...
  --radius-md: 12px;
  --radius-lg: 12px;
  --font-display: -apple-system, "Segoe UI", "Inter", "PingFang SC", "Hiragino Sans GB", "Noto Sans SC", "Microsoft YaHei", sans-serif;
  ...
  --font-latin-display: -apple-system, "Segoe UI", "Inter", sans-serif;
  --region-canvas-bg: #211101;
  --region-canvas-text: #fdf9f5;
  --region-canvas-text-secondary: #cec4b8;
  --region-canvas-border: #42382c;
  --region-canvas-surface: #281a08;
  --region-canvas-action: #fdf9f6;
  --region-canvas-action-text: #0b0a09;
  --region-canvas-focus: #fdf9f6;
  --region-canvas-success: #559247;
  --region-canvas-warning: #d56e48;
  --region-canvas-error: #c64d49;
  --region-canvas-info: #2389d1;
  --region-brand-bg: #4a1700;
  --region-brand-text: #fff8ec;
  --region-brand-text-secondary: #d3c3b1;
  --region-brand-border: #5b4935;
  --region-brand-surface: #592a00;
  --region-brand-action: #fff8ee;
  --region-brand-action-text: #0c0a08;
  --region-brand-focus: #fff8ee;
  --region-brand-success: #559247;
  --region-brand-warning: #d56e48;
...
/* 标准中文排版：中性无衬线、字面标准、笔画均匀；依靠字号与字重建立层级
