...
## 品牌共性
- 风格：光谱。清晰的仪器刻度、精确的线条和数据对齐
- 表面语言：薄边界和少量偏移阴影；结构由清晰分组承担
- 形状：3px / 6px / 6px；同类组件全站一致。
...
- 当前风格字形：几何骨架、字面偏窄、笔画粗细均匀；标题收紧字距，数字用等宽表格式
- 展示字体：`"Avenir Next", "Inter", "Segoe UI", "PingFang SC", "Hiragino Sans GB", "Noto Sans SC", "Microsoft YaHei", sans-serif`
...
- `--radius-sm`: 3px — 光谱品牌形状
- `--radius-md`: 6px — 光谱品牌形状
- `--radius-lg`: 6px — 光谱品牌形状
### 排版
...
### 字体
- `--font-display`: "Avenir Next", "Inter", "Segoe UI", "PingFang SC", "Hiragino Sans GB", "Noto Sans SC", "Microsoft YaHei", sans-serif — 光谱展示字体。几何骨架、字面偏窄、笔画粗细均匀；标题收紧字距，数字用等宽表格式
...
- `--font-latin-display`: "Avenir Next", "Inter", "Segoe UI", sans-serif — 拉丁展示字体
### 间距阶梯
...
[data-theme="dark"] {
  ...
  --radius-md: 6px;
  --radius-lg: 6px;
  --font-display: "Avenir Next", "Inter", "Segoe UI", "PingFang SC", "Hiragino Sans GB", "Noto Sans SC", "Microsoft YaHei", sans-serif;
  ...
  --font-latin-display: "Avenir Next", "Inter", "Segoe UI", sans-serif;
...
/* 光谱中文排版：几何骨架、字面偏窄、笔画粗细均匀；标题收紧字距，数字用等宽表格式
