...
- 中文行宽：正文按全角字数控制（30em），不直接套用英文 65–75ch；阅读页面优先保证行长与段落节奏。
...
### 页面用途
- `--type-display-size`: clamp(2.5rem, 6vw, 5.5rem) — 作品展示用途角色
- `--type-title-size`: 2rem — 作品展示用途角色
- `--type-section-size`: 1.375rem — 作品展示用途角色
- `--type-body-size`: 1rem — 作品展示用途角色
- `--type-label-size`: 0.875rem — 作品展示用途角色
- `--type-meta-size`: 0.75rem — 作品展示用途角色
- `--type-display-leading`: 1.12 — 作品展示用途角色
- `--type-body-leading`: 1.75 — 作品展示用途角色
- `--type-display-weight`: 700 — 作品展示用途角色
- `--type-display-tracking`: -0.025em — 作品展示用途角色
- `--measure-title`: 12em — 作品展示用途角色
- `--measure-prose`: 30em — 作品展示用途角色
- `--layout-content-width`: 90rem — 作品展示用途角色
- `--layout-section-gap`: 6rem — 作品展示用途角色
- `--layout-panel-padding`: 1.5rem — 作品展示用途角色
- `--layout-stack-gap`: 0.75rem — 作品展示用途角色
- `--layout-control-padding`: 0.5rem — 作品展示用途角色
- `--motion-feedback-duration`: 240ms — 作品展示用途角色
### 区域配色
...
- `--space-card-padding`: 1.5rem — 作品展示内容表面内边距
- `--space-card-gap`: 0.75rem — 卡片间水平间距
- `--space-section-gap`: 6rem — 作品展示区块垂直间距
